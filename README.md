...
|CI/CD|[![Node.js Package Publish (Commit) (Linux)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-linux.yml/badge.svg)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-linux.yml) [![Node.js Package Publish (Commit) (Raspberry-Pi-arm)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-linux-pi-2b.yml/badge.svg)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-linux-pi-2b.yml) [![Node.js Package Publish (Commit) (Windows)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-windows.yml/badge.svg)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/npm-publish-windows.yml) [![Node.js Package Publish (Commit) (WebUI)](https://github.com/MaoJianwei/Mao-Service-Discovery/actions/workflows/npm-publish-webui.yml/badge.svg)](https://github.com/MaoJianwei/Mao-Service-Discovery/actions/workflows/npm-publish-webui.yml) [![Docker Image Publish](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/docker-publish.yml/badge.svg)](https://github.com/MaoJianwei/Mao_Service_Discovery/actions/workflows/docker-publish.yml)|
|Linux Package|[Github Docker Image](https://github.com/MaoJianwei/Mao-Service-Discovery/pkgs/container/mao-service-discovery) = [NPM official](https://www.npmjs.com/package/mao-service-discovery?activeTab=versions) = [Taobao & Alibaba Cloud mirror](https://npmmirror.com/package/mao-service-discovery/versions?tags=all&versions=all)|
|Raspberry Pi Package|[NPM official](https://www.npmjs.com/package/mao-service-discovery-raspberry-pi?activeTab=versions) = [Taobao & Alibaba Cloud mirror](https://npmmirror.com/package/mao-service-discovery-raspberry-pi/versions?versions=all&tags=all)|
|Windows Package|[NPM official](https://www.npmjs.com/package/mao-service-discovery-windows?activeTab=versions) = [Taobao & Alibaba Cloud mirror](https://npmmirror.com/package/mao-service-discovery-windows/versions?versions=all&tags=all)|
|WebUI Package|[NPM official](https://www.npmjs.com/package/mao-service-discovery-webui?activeTab=versions) = [Taobao & Alibaba Cloud mirror](https://npmmirror.com/package/mao-service-discovery-webui/versions?versions=all&tags=all)|
